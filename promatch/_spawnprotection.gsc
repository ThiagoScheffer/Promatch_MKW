...
init()
{
	...
	level.scr_spawn_protection_hiticon = getdvarx( "scr_spawn_protection_hiticon", "int", 0, 0, 1 );
	...
	if(level.gametype != "ass")
	return;
	
	// Get the module's dvars
	level.scr_spawn_protection_time = getdvarx( "scr_spawn_protection_time", "float", 1, 0.5, 60 );
	...
	level.scr_spawn_protection_punishment_time = getdvarx( "scr_spawn_protection_punishment_time", "float", 4, 0, 15 );
