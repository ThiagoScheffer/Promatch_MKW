...
{
	if ( isString( value ) ) {
		value = getdvarx( dvar, "string", value );
	}	else {
		value = getdvarx( dvar, "int", value );
	}
...
init()
{
	...
	//registerTweakable( "player", 		"maxhealth", 			"scr_player_maxhealth", 			105 ); //*
	//registerTweakable( "player", 		"healthregentime", 		"scr_player_healthregentime", 		4 ); //*
