...
vehicle_80s_sedan1( color )
{
	...
	// 80's Sedan
	//---------------------------------------------------------------------
	destructible_create( "vehicle_80s_sedan1_" + color, 650, undefined, 32, "no_melee" );
...
//			destructible_sound( "veh_tire_deflate", "bullet" );
		...
		// Glass ( Front )
		tag = "tag_glass_front";
		destructible_part( tag, "vehicle_80s_sedan1_glass_F", 1 );
		...
		// Glass ( Back )
		tag = "tag_glass_back";
		destructible_part( tag, "vehicle_80s_sedan1_glass_B", 1 );
		...
		destructible_part( tag, "vehicle_80s_sedan1_glass_LF", 1, undefined );
		...
		destructible_part( tag, "vehicle_80s_sedan1_glass_RF", 1, undefined );
		...
		destructible_part( tag, "vehicle_80s_sedan1_glass_LB", 1, undefined );
		...
		destructible_part( tag, "vehicle_80s_sedan1_glass_RB", 1, undefined );
...
vehicle_80s_wagon1( color )
{
	...
	// 80's wagon
	//---------------------------------------------------------------------
	destructible_create( "vehicle_80s_wagon1_" + color, 650, undefined, 32, "no_melee" );
				destructible_loopfx( "tag_hood_fx", "smoke/car_damage_whitesmoke", 0.4 );
		...
		// Glass ( Front )
		tag = "tag_glass_front";
		destructible_part( tag, "vehicle_80s_wagon1_glass_F", 1 );
		...
		// Glass ( Back )
		tag = "tag_glass_back";
		destructible_part( tag, "vehicle_80s_wagon1_glass_B", 1 );
		...
		// Glass ( Left Front )
		tag = "tag_glass_left_front";
		destructible_part( tag, "vehicle_80s_wagon1_glass_LF", 1 );
		...
		// Glass ( Right Front )
		tag = "tag_glass_right_front";
		destructible_part( tag, "vehicle_80s_wagon1_glass_RF", 1 );
		...
		// Glass ( Left Back )
		tag = "tag_glass_left_back";
		destructible_part( tag, "vehicle_80s_wagon1_glass_LB", 1 );
		...
		// Glass ( Right Back )
		tag = "tag_glass_right_back";
		destructible_part( tag, "vehicle_80s_wagon1_glass_RB", 1 );
		...
		destructible_part( tag, "vehicle_80s_wagon1_glass_LB2", 1 );
		...
		destructible_part( tag, "vehicle_80s_wagon1_glass_RB2", 1 );
...
vehicle_80s_hatch1( color )
{
	...
	// 80's hatchback
	//---------------------------------------------------------------------
	destructible_create( "vehicle_80s_hatch1_" + color, 650, undefined, 32, "no_melee" );
				destructible_loopfx( "tag_hood_fx", "smoke/car_damage_whitesmoke", 0.4 );
		...
		// Glass ( Front )
		tag = "tag_glass_front";
		destructible_part( tag, "vehicle_80s_hatch1_glass_F", 1 );
		...
		// Glass ( Back )
		tag = "tag_glass_back";
		destructible_part( tag, "vehicle_80s_hatch1_glass_B", 1 );
		...
		// Glass ( Left Front )
		tag = "tag_glass_left_front";
		destructible_part( tag, "vehicle_80s_hatch1_glass_LF", 1 );
		...
		// Glass ( Right Front )
		tag = "tag_glass_right_front";
		destructible_part( tag, "vehicle_80s_hatch1_glass_RF", 1 );
		...
		// Glass ( Left Back )
		tag = "tag_glass_left_back";
		destructible_part( tag, "vehicle_80s_hatch1_glass_LB", 1 );
		...
		// Glass ( Right Back )
		tag = "tag_glass_right_back";
		destructible_part( tag, "vehicle_80s_hatch1_glass_RB", 1 );
...
vehicle_small_wagon( color )
{
	...
	// small wagon
	//---------------------------------------------------------------------
	destructible_create( "vehicle_small_wagon_" + color, 650, undefined, 32, "no_melee" );
				destructible_loopfx( "tag_hood_fx", "smoke/car_damage_whitesmoke", 0.4 );
		...
		// Glass ( Front )
		tag = "tag_glass_front";
		destructible_part( tag, "vehicle_small_wagon_glass_F", 1 );
		...
		// Glass ( Back )
		tag = "tag_glass_back";
		destructible_part( tag, "vehicle_small_wagon_glass_B", 1 );
		...
		// Glass ( Left Front )
		tag = "tag_glass_left_front";
		destructible_part( tag, "vehicle_small_wagon_glass_LF", 1 );
		...
		// Glass ( Right Front )
		tag = "tag_glass_right_front";
		destructible_part( tag, "vehicle_small_wagon_glass_RF", 1 );
		...
		// Glass ( Left Back )
		tag = "tag_glass_left_back";
		destructible_part( tag, "vehicle_small_wagon_glass_LB", 1 );
		...
		// Glass ( Right Back )
		tag = "tag_glass_right_back";
		destructible_part( tag, "vehicle_small_wagon_glass_RB", 1 );
...
vehicle_small_hatch( color )
{
	...
	// small hatch
	//---------------------------------------------------------------------
	destructible_create( "vehicle_small_hatch_" + color, 650, undefined, 32, "no_melee" );
				destructible_loopfx( "tag_hood_fx", "smoke/car_damage_whitesmoke", 0.4 );
		...
		// Glass ( Front )
		tag = "tag_glass_front";
		destructible_part( tag, "vehicle_small_hatch_glass_F", 1 );
		...
		// Glass ( Back )
		tag = "tag_glass_back";
		destructible_part( tag, "vehicle_small_hatch_glass_B", 1 );
		...
		// Glass ( Left Front )
		tag = "tag_glass_left_front";
		destructible_part( tag, "vehicle_small_hatch_glass_LF", 1 );
		...
		// Glass ( Right Front )
		tag = "tag_glass_right_front";
		destructible_part( tag, "vehicle_small_hatch_glass_RF", 1 );
		...
		// Glass ( Left Back )
		tag = "tag_glass_left_back";
		destructible_part( tag, "vehicle_small_hatch_glass_LB", 1 );
		...
		// Glass ( Right Back )
		tag = "tag_glass_right_back";
		destructible_part( tag, "vehicle_small_hatch_glass_RB", 1 );
...
vehicle_80s_hatch2( color )
{
	...
	// 80's hatchback 2
	//---------------------------------------------------------------------
	destructible_create( "vehicle_80s_hatch2_" + color, 650, undefined, 32, "no_melee" );
				destructible_loopfx( "tag_hood_fx", "smoke/car_damage_whitesmoke", 0.4 );
		...
		// Glass ( Front )
		tag = "tag_glass_front";
		destructible_part( tag, "vehicle_80s_hatch2_glass_F", 1 );
		...
		// Glass ( Back )
		tag = "tag_glass_back";
		destructible_part( tag, "vehicle_80s_hatch2_glass_B", 1 );
		...
		// Glass ( Left Front )
		tag = "tag_glass_left_front";
		destructible_part( tag, "vehicle_80s_hatch2_glass_LF", 1 );
		...
		// Glass ( Right Front )
		tag = "tag_glass_right_front";
		destructible_part( tag, "vehicle_80s_hatch2_glass_RF", 1 );
		...
		// Glass ( Left Back )
		tag = "tag_glass_left_back";
		destructible_part( tag, "vehicle_80s_hatch2_glass_LB", 1 );
		...
		// Glass ( Right Back )
		tag = "tag_glass_right_back";
		destructible_part( tag, "vehicle_80s_hatch2_glass_RB", 1 );
...
vehicle_uaz_fabric( destructibleType )
{
	destructible_create( "vehicle_uaz_fabric_", 500, undefined, 32, "no_melee" );
		...
		// Glass ( Front )
		tag = "tag_glass_front";
		destructible_part( tag, "vehicle_uaz_glass_F", 1 );
